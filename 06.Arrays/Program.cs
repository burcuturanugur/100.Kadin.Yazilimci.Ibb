internal class Program
{
    private static void Main(string[] args)
    {
        ...
        //// İlginç bir kullanım
        //int[] dizi19 = new int[5] { 2, 3, 6, 8, 7 }; //Dizinin kaç boyut olacağını da dizide tutuyor.
        ...
        //foreach (string isim in metinsel) //dizilerde yazdırma işlemi foreachle yapılır.
        //    Console.Write(isim + " ");

        //Console.WriteLine("\n\nSıralı dizi:");

        //Array.Sort(metinsel); //diziyi sıraladı
        ...
        Console.WriteLine("\n\n\n");
        //
        string[] dizi29 = { "Ankara", "Bursa", "Kastamonu", "Bolu", "Manisa", "Aydın", "Kocaeli", "Ağrı", "Rize", "Çankırı","Ordu","Lüleburgaz" };
        ...
        Console.Write(Array.BinarySearch(dizi29, 3, 3, "Manisa")); // BinarySearch burada 3. indeksten itibaren 4 eleman içinde "Manisa"yı arar. Bulursa indeksini tutar. Bulamazsa negatif bir sayı tutar. NOT : Yalnızca tek boyutlu diziler Sort ile sıralanabilir, dolayısıyla da çok boyutlu dizilerde hem Sort ile sıralama hem de BinarySearch ile arama yapmak imkansızdır.
